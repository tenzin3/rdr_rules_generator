...
from rules_generator.RDRPOSTagger.Utility.Utils import getWordTag, readDictionary


def computeAccuracy(goldStandardCorpus, taggedCorpus):
    tagged = open(taggedCorpus).read().split()
    goldStandard = open(goldStandardCorpus).read().split()
